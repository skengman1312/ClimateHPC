...
int main (int argc, char *argv[]){
    ...
    for (k = 0;k<N_TIME; k++){
        ...
        /*TIME END T1*/
        sum_nc_reading = nc_reading;
        sum_threading_time = threading_time;
        total_time_reading += sum_nc_reading ;
        total_time_threading += sum_threading_time ;
